...
The Module composed by a function that multiplies 2 matrices
...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        TypeError: if m_a or m_b aren not a list
        ...
        TypeError: if the rows of m_a or m_b do not have the same size
